...
// символы
// график
byte curs[8] = {0b00000,  0b00100,  0b01110,  0b11011,  0b01110,  0b00100,  0b00000,  0b00000};   // ромбик (курсор)
...
* Используются для настройки времени вручную.
*/
uint8_t dateTimeCursorPos;
uint8_t currentHrs, currentMins, currentDay, currentMonth;
